...
export COSE_DATA_DIR="${PROJECT_CODE_PATH}/data_dir/quick_draw"
export COSE_LOG_DIR="${PROJECT_CODE_PATH}/log_dir/quick_draw"
export COSE_EVAL_DIR="${PROJECT_CODE_PATH}/eval_dir/quick_draw"
